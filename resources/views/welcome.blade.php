...
<body>
    ...
    <section id="topbar" class="d-none d-lg-block">
        <div class="container d-flex">
            ...
            <div class="cta">
                <a href="" class="scrollto"><i class="icofont-facebook"></i></a>
                <a href="" class="scrollto"><i class="icofont-youtube"></i></a>
                <a href="" class="scrollto"><i class="icofont-envelope"></i></a>
    ...
    <header id="header">
        <div class="container d-flex">
            <div class="logo mr-auto">
                ...
                <a href="index.html"><img src="assets/img/logo.jpg" alt="" class=""></a>
            </div>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="container" data-aos="fade-in">
            ...
            <h2>Our team is looking for a young entrepreneur, and wanted to rich thier goal early.</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-5" data-aos="fade-up">
                        <div class="content">
                            <h3>Why Choose Empowered Consumerism?</h3>
                            <p>
                                Empowered Consumerism offers a financial program which pays a commission for referring sales. Successful Results of our members are not a guarantee that you will make money. Your results will vary and depend on many factors …including but not limited
                                to your background, experience, and work ethic.
                            </p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                        ...
                        <p data-aos="fade-up">Esse voluptas cumque vel exercitationem. Reiciendis est hic accusamus. Non ipsam et sed minima temporibus laudantium. Soluta voluptate sed facere corporis dolores excepturi. Libero laboriosam sint et id nulla tenetur. Suscipit
                            aut voluptate.</p>
